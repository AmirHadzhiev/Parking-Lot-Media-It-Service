...
public class ParkingDeleteDialog extends Dialog {
    TextField idField = new TextField("Parking Id");



    public ParkingDeleteDialog() {


        H2 headline = new H2("Delete parking by Id");
        ...
        deleteButton.addClickListener(buttonClickEvent -> {
            ...
            fireEvent(new DeleteEvent(this,idForDelete) );
            this.close();
        });
    ...
    public static class DeleteEvent extends ParkingDeleteDialog.ParkingDialogEvent {
    ...
    public static class CloseEvent extends ParkingDeleteDialog.ParkingDialogEvent {
