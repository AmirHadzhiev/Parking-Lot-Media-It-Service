...
public class CarDeleteDialog extends Dialog {
    TextField idField = new TextField("Parking Id");



    public CarDeleteDialog() {


        H2 headline = new H2("Delete car by Id");
        ...
        deleteButton.addClickListener(buttonClickEvent -> {
            ...
            fireEvent(new CarDeleteDialog.DeleteEvent(this,idForDelete) );
            this.close();
        });
    ...
    public static class DeleteEvent extends CarDeleteDialog.ParkingDialogEvent {
    ...
    public static class CloseEvent extends CarDeleteDialog.ParkingDialogEvent {
