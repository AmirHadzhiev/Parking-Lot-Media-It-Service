...
public class ParkingPlaceDeleteDialog extends Dialog {

    TextField idField = new TextField("Parking Place Id");


    public ParkingPlaceDeleteDialog() {


        H2 headline = new H2("Delete Parking Place by Id");
        ...
        deleteButton.addClickListener(buttonClickEvent -> {
            ...
            fireEvent(new ParkingPlaceDeleteDialog.DeleteEvent(this, idForDelete));
            this.close();
        });
    ...
    public static class DeleteEvent extends ParkingPlaceDeleteDialog.ParkingDialogEvent {
    ...
    public static class CloseEvent extends ParkingPlaceDeleteDialog.ParkingDialogEvent {
